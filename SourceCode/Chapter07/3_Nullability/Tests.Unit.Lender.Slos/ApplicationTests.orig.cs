namespace Tests.Unit.Lender.Slos.Nullability
{
    ...
    public class WithoutNullabilityTests
    {
        [Test]
        public void Save_WithNoDateOnApplication_ExpectToday()
        {
            // Arrange
            var classUnderTest = WithoutNullabilityTestsHelper.CreateApplication();
        ...
        public void Save_WithNoId_ExpectNextId()
        {
            ...
            WithoutNullabilityTestsHelper.NextId = expectedNextId;
        ...
        {
            // Arrange
            WithoutNullabilityTestsHelper.NextId = new Guid("62C78CED-8765-4B99-A3F8-366AAF5B7C22");

            var expectedId = new Guid("95C90124-4CBE-4465-9A31-10EEE35E51D8");
            var classUnderTest = WithoutNullabilityTestsHelper.CreateApplication(expectedId);
